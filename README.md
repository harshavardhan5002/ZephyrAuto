...
| Name    | Email           |
|---------|-----------------|
| Harshavardhan S | harshavardhansomanathan@gmail.com |
| Someshwar S | someshwar1006@gmail.com |
...
5. Power on the vehicle and ensure all sensors are functioning correctly.

6. Use the keypad interface to select the desired mode (DRIVE, REVERSE, PARK, CRUISE, LANEKEEP).

7. Follow the instructions displayed on the LCD screen for each mode.

8. The System will take action automatically according to the data received from the sensors.
